...
try {
    ...
    $mail->addAddress('radeanf@gmail.com');     // Add a recipient

    //Content
    $message = '<html><body>';
    $message .= '<h2>ABSA Booking Enquiry.</h2>';
    $message .= '<table rules="all" style="border-color: #666;" cellpadding="10">';
    $message .= "<tr style='background: #eee;'><td><strong>Customer's Name:</strong> </td><td>" . strip_tags($_POST['fullName']) . "</td></tr>";
    $message .= "<tr><td><strong>Email:</strong> </td><td>" . strip_tags($_POST['email']) . "</td></tr>";
    $message .= "<tr><td><strong>Phone Number:</strong> </td><td>" . strip_tags($_POST['phoneNumber']) . "</td></tr>";
    $message .= "<tr><td><strong>Quote Number:</strong> </td><td>" . strip_tags($_POST['quoteNumber']) . "</td></tr>";
